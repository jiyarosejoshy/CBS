...
//   const fetchTransactions = async (date) => {
//     try {
//       const response = await axios.get(`/api/teller/transactions/${date}`);
//       setTransactions(response.data.transactions || []);
//     } catch (error) {
//       console.error("Error fetching transactions:", error);
//     }
...
//     try {
//       const [openBalRes, closeBalRes] = await Promise.all([
//         axios.get(`/api/teller/opening-balance/${date}`),
//         axios.get(`/api/teller/closing-balance/${date}`)
//       ]);
...
//     try {
//       const response = await axios.post("http://localhost:5000/api/teller/transaction", {
//         amount: formData.amount,
//         trans_type: formData.trans_type,
//         acc_no: formData.acc_no,
//         first_name: formData.first_name,
...
//                       <CheckCircle className="h-5 w-5" />
//                       <span className="font-medium">Transaction ID:</span>
//                       <span className="font-mono">{txn.trans_id}</span>
//                     </div>
//                     <Button
//                       variant="ghost"
//                       size="sm"
