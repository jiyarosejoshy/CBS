...
const NavBar = () => {
  ...
  return (
    <nav className="bg-gradient-to-r from-green-900 to-indigo-900 p-4 shadow-lg">
      <div className="max-w-6xl mx-auto flex justify-between items-center">
        ...
        <div className="flex gap-6 items-center">
          <NavLink href="/teller/dashboard">Dashboard</NavLink>
          <NavLink href="/teller/log-entry">Logs</NavLink>
